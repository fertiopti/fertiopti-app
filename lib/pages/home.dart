...
import 'package:agri_connect/utils/linechart.dart';
import 'package:agri_connect/utils/npk_box.dart';
import 'package:agri_connect/utils/sensor_data_box.dart';
import 'package:agri_connect/utils/shimmerWidget.dart';
            ...
            child: ListView(
              children: [
                ...
                ReusableContainer(
                    ...
                    child: Row(
                      children: [
                        Text("Motor Control", style: TextStyle(color: Colors.white54, fontWeight: FontWeight.w600, fontSize: 20),),
                        Spacer(),
                        RotationTransition(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        IconButton(
                          icon: Icon(Icons.g_translate, color: Colors.white54),
                          onPressed: () {
      ...
      return Padding(
        ...
        child: MarkdownBody(
          ...
          styleSheet: MarkdownStyleSheet(
            h2: TextStyle(fontSize: 20, color: Colors.white54),
